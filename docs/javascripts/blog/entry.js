...
$(function()
{
  $("#CommentSubmitButton").click(function(e) {
  		...
  		/*
  		var formFirstName = document.getElementById("NewUserObject-firstName").value;
  		var formLastName = document.getElementById("NewUserObject-lastName").value;
  		var formEmail = document.getElementById("NewUserObject-email").value;
  		*/
  		var formFirstName = document.getElementById("NewEntryCommentObject-firstName").value;
  		var formLastName = document.getElementById("NewEntryCommentObject-lastName").value;
  		var formEmail = document.getElementById("NewEntryCommentObject-email").value;
  		var formContent = document.getElementById("NewEntryCommentObject-content").value;
  		var formEntryId = document.getElementById("NewEntryObject-id").value;
  		var formEntryDiscussionId = document.getElementById("entryDiscussionId").value;
  		var formEntryWantsReplies = document.getElementById("NewEntryCommentObject-wantsReplies").value;
  		
  		
  		//Captcha
  		var formRecaptchaResponseField = document.getElementById("recaptcha_response_field").value;
  		var formRecaptchaChallengeField = document.getElementById("recaptcha_challenge_field").value;

		if (debug) alert("id of recaptcha_response_field = " + document.getElementById("recaptcha_response_field").value)  		

		//alert(formEntryWantsReplies);
		  		...
		  		data:	{ 	
		  					...
		  					*/
		  					NewEntryCommentObject:	{
		  												...
		  												lastName	: formLastName,
		  												email		: formEmail,
		  												entryDiscussionId	: formEntryDiscussionId,
		  												wantsReplies : formEntryWantsReplies
		  											},
		  					NewEntryObject	:	{
		  											id	: formEntryId
			  									},
